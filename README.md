...
Amebis company; it was later also installed on the their [Termania
...
* [Scripts directory](Scripts/) contains the scripts used for processing the
  dictionary; note that the scripts assume a Linux operating system and that various prerequsites are installed.
